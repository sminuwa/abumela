                ...
                <div class="col s12 m12 l12">
                    <div id="button-trigger" class="card card card-default scrollspy">
                        <div class="card-content">
                            <h4 class="card-title">Print Mails</h4>
                            <div class="row">
                                            ...
                                            <table width="50">
                                                ...
                                                @foreach($mails as $mail)
                                                    <tr>
                                                        <td>
                                                            <label>
                                                                <input name="checkbox[]" class="checkbox" type="checkbox" value="{{ $mail->id }}" id="mail-{{ $mail->id }}" onclick="deSelectMail(this.value);" checked>
                                                                <span>{{ $sno }}</span>
                                                            </label>
                                                        </td>
                                                ...
                                                <tr>
                                                    <th style="min-width: 0px; width:40px">
                                                        <a href="{{url('/mail/print-mail')}}" class="btn btn-success" target="_blank">Print</a>
                                                    </th>
                                                    <th>TITLE</th>
                                                    <th>DATE</th>
                                                </tr>
